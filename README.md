...
- Git の基本操作（branch, commit, push）ができること。
...
| 3   | 依存関係管理                   | Dependabot で脆弱性を検知し自動修正する         |
| EX  | 監視・アラート                 | 定期ヘルスチェックで障害を検知する（時間が余ったら） |
...
4. [docs/HANDSON-3-DEPENDABOT.md](docs/HANDSON-3-DEPENDABOT.md)
3. [docs/HANDSON-EX-MONITORING.md](docs/HANDSON-EX-MONITORING.md)
...
│   ├── HANDSON-3-DEPENDABOT.md  # ← ハンズオン 3
│   ├── HANDSON-EX-MONITORING.md # ← ハンズオン EX
│   ├── templates/               # ← 穴埋めテンプレート
│   │   ├── workflows/
│   │   │   ├── ci.yml
│   │   │   ├── deploy.yml
